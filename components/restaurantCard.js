    ...
    <TouchableOpacity
      ...
      />
          ...
          <View className="absolute top-3 right-3">
            <View className="bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full flex-row items-center">
              ...
              <Text className={`text-xs font-bold ${getRatingColor(item.stars)}`}>
                {item.stars}
              </Text>
            </View>
          </View>
      ...
      <View className="p-4">
          ...
          <Text className="text-sm text-gray-700">
              <Text className={`font-semibold ${getRatingColor(item.stars)}`}>
                {item.stars}
              </Text>
          ...
          <View className="flex-row items-center space-x-1 mb-2">
            <Icon.MapPin height={14} width={14} stroke="#6B7280" />
